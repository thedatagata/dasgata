// islands/onboarding/DepartmentSelection.tsx
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div class="mb-12">
        <div class="flex items-center justify-center space-x-2 mb-4">
          ...
          <div class="w-8 h-8 bg-[#F8F6F0]/30 rounded-full flex items-center justify-center text-[#F8F6F0] font-bold">2</div>
          <div class="w-16 h-1 bg-[#F8F6F0]/30"></div>
        ...
        {departments.map((dept) => (
          ...
          >
            ...
            <div class="relative">
              ...
              <h3 class="text-2xl font-bold text-white mb-2">{dept.name}</h3>
              <p class="text-white/90 font-light">{dept.description}</p>
      ...
      <div class="text-center mt-12">
        <a href="/onboarding/metrics" class="text-[#F8F6F0]/60 hover:text-[#90C137] transition-colors text-sm">
          Skip this step →
        </a>
      </div>
    </div>
