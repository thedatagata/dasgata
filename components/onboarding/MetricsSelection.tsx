// components/onboarding/MetricsSelection.tsx
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-xl text-[#F8F6F0]/80">
          Select 2-5 metrics to track (choose at least 2)
        </p>
      </div>
          ...
          return (
            <button
              ...
              class={`p-6 rounded-lg border-2 transition-all ${
                isSelected
                  ? 'bg-[#90C137]/20 border-[#90C137] shadow-lg scale-105'
            ...
            >
              <div class="flex items-start justify-between mb-3">
                <div class={`w-12 h-12 rounded-lg flex items-center justify-center ${
                  ...
                  <i class={`fas ${metric.icon} text-xl ${
